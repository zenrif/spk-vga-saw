...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl mt-4" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <h4 class="font-weight-bolder mb-0">Ubah Data VGA</h4>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <form method="post" action="/vga/{{ $vga->id }}" class="mb-5" enctype="multipart/form-data"
                ...
                <div class="col-lg-10 mx-2">
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="nama_vga" name="nama_vga" required autofocus
                                value="{{ old('nama_vga', $vga->nama_vga) }}">
                        </div>
                        @error('nama_vga')
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="harga" name="harga" required
                                value="{{ old('nama_vga', $vga->harga) }}"
                                placeholder="Contoh : Rp1.500.000, masukkan 1500000">
                        </div>
                        @error('harga')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="memori" name="memori" required
                                value="{{ old('nama_vga', $vga->memori) }}" placeholder="Contoh : 4 GB, masukkan 4">
                        </div>
                        @error('memori')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="core_clock" name="core_clock" required
                                value="{{ old('nama_vga', $vga->core_clock) }}"
                                placeholder="Contoh : 800 MHz, masukkan 800">
                        </div>
                        @error('core_clock')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="memory_clock" name="memory_clock" required
                                value="{{ old('nama_vga', $vga->core_clock) }}"
                                placeholder="Contoh : 500 MHz, masukkan 500">
                        </div>
                        @error('memory_clock')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <div class="col-sm-5 mb-3">
                            <input type="text" class="form-control" id="daya" name="daya" required
                                value="{{ old('nama_vga', $vga->daya) }}" placeholder="Contoh : 70 W, masukkan 70">
                        </div>
                        @error('daya')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <label for="gambar" class="form-label" style="color:black; font-weight:bold;">Gambar</label>
                        <div class="col-sm-3">
                            <img class="gambar-preview img-fluid" src="/img/{{ $vga->gambar }}">
                        </div>
                        <div class="col-sm-7">
